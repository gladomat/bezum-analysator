(() => {
  ...
  const I18N = {
    de: {
      ...
      help_prob_intro: "Du willst wissen: ‚Wie wahrscheinlich ist es, dass heute (oder zu einer bestimmten Stunde / auf einer bestimmten Linie) kontrolliert wird?' Damit diese Schätzung stabil ist, auch wenn du manchmal nur wenige Beobachtungen hast, nutzt das Modell eine statistische Methode namens Beta-Bernoulli-Modell. Das klingt kompliziert, ist aber im Kern sehr einfach: Bernoulli heißt: an einem Tag/stündlichen Zeitfenster gibt es entweder Kontrolle erkannt (= Erfolg) oder keine Kontrolle (= kein Erfolg). Beta ist eine Wahrscheinlichkeitsverteilung, die hilft, aus Beobachtungen eine glatte, stabile Wahrscheinlichkeit abzuleiten, statt sprunghaft nur ‚Kontrolle JA/NEIN' zu sagen. Das Jeffreys-Prior (ein Mini-Vorwissen mit 0.5/0.5) sorgt dafür, dass das Modell: nicht zu optimistisch ist, wenn du wenige Daten hast, und auch nicht ‚denkt', eine Stunde ohne Kontrolle bedeutet gleich ‚nie Kontrollen'. Kurz: Das Modell glättet das Rauschen deiner Beobachtungen, damit die Kontrollwahrscheinlichkeit realistisch aussieht.",
      help_prob_day: "Tagesmodell: Erfolg heißt hier: Mindestens eine Kontrolle wurde an diesem Tag beobachtet. Das Modell schätzt also: Wie oft werden an einem Tag irgendwo Kontrollen erkannt? Beispiel: Wenn du über Wochen beobachtest, dass etwa jeder dritte Tag eine Kontrolle vorkommt, wird die Wahrscheinlichkeit ≈ 33–40 % liegen – leicht geglättet durch die Beta-Verteilung.",
      help_prob_hour: "Linienmodell: Hier wird feiner aufgelöst:\n„Erfolg“ heißt: In einem bestimmten Zeitfenster (z. B. Linie 5, 14–15 Uhr, am 3. Februar) wurde mindestens eine Kontrolle erkannt. Damit bekommst du Aussagen wie: Zwischen 7 und 9 Uhr sind Kontrollen wahrscheinlicher. Auf Linie 11 gibt es abends kaum Kontrollen.",

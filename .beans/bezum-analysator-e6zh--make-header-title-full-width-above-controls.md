...
## Checklist
- [x] Update header HTML structure for title row + controls row
- [x] Update CSS layout for full-width title and lower controls
- [x] Verify UI still works and run tests

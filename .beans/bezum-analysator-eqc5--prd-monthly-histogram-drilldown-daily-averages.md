...
- Shows a histogram per month
- Clicking a month drills into weekly view with per-day histograms
- Shows the average for each day within the selected month

## Checklist
- [x] Review existing repo context (data + UI)
- [x] Define user stories and UX flows
- [x] Specify data model + aggregation requirements
